  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=d583e8b046';
  import { pkConfirm, pkAlert } from './modal.js?v=d583e8b046';
  import { injectCss } from './inject-css.js?v=d583e8b046';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=d583e8b046'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=d583e8b046';
  import pkComponentsCss from './design/components.css.js?v=d583e8b046';
  (() => {
    'use strict';
