  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=e9a2659055';
  import { pkConfirm, pkAlert } from './modal.js?v=e9a2659055';
  import { injectCss, injectFont } from './inject-css.js?v=e9a2659055';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=e9a2659055'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=e9a2659055';
  import pkComponentsCss from './design/components.css.js?v=e9a2659055';
  (() => {
    'use strict';
