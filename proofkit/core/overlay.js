  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=fbbd97f7b0';
  import { pkConfirm, pkAlert } from './modal.js?v=fbbd97f7b0';
  import { injectCss } from './inject-css.js?v=fbbd97f7b0';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=fbbd97f7b0'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=fbbd97f7b0';
  import pkComponentsCss from './design/components.css.js?v=fbbd97f7b0';
  (() => {
    'use strict';
