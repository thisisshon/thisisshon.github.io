  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=f4733f050b';
  import { pkConfirm, pkAlert } from './modal.js?v=f4733f050b';
  import { injectCss, injectFont } from './inject-css.js?v=f4733f050b';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=f4733f050b'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=f4733f050b';
  import pkComponentsCss from './design/components.css.js?v=f4733f050b';
  (() => {
    'use strict';
