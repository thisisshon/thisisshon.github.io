  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=9ad1aa41ba';
  import { pkConfirm, pkAlert } from './modal.js?v=9ad1aa41ba';
  import { injectCss, injectFont } from './inject-css.js?v=9ad1aa41ba';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=9ad1aa41ba'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=9ad1aa41ba';
  import pkComponentsCss from './design/components.css.js?v=9ad1aa41ba';
  (() => {
    'use strict';
