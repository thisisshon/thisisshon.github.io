  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=c909067c04';
  import { pkConfirm, pkAlert } from './modal.js?v=c909067c04';
  import { injectCss, injectFont } from './inject-css.js?v=c909067c04';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=c909067c04'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=c909067c04';
  import pkComponentsCss from './design/components.css.js?v=c909067c04';
  (() => {
    'use strict';
