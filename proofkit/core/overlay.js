  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=fa5774af8c';
  import { pkConfirm, pkAlert } from './modal.js?v=fa5774af8c';
  import { injectCss } from './inject-css.js?v=fa5774af8c';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=fa5774af8c'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=fa5774af8c';
  import pkComponentsCss from './design/components.css.js?v=fa5774af8c';
  (() => {
    'use strict';
