  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=affd2ffcbc';
  import { pkConfirm, pkAlert } from './modal.js?v=affd2ffcbc';
  import { injectCss } from './inject-css.js?v=affd2ffcbc';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=affd2ffcbc'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=affd2ffcbc';
  import pkComponentsCss from './design/components.css.js?v=affd2ffcbc';
  (() => {
    'use strict';
