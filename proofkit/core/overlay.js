  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=ab5ed8c128';
  import { pkConfirm, pkAlert } from './modal.js?v=ab5ed8c128';
  import { injectCss } from './inject-css.js?v=ab5ed8c128';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=ab5ed8c128'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=ab5ed8c128';
  import pkComponentsCss from './design/components.css.js?v=ab5ed8c128';
  (() => {
    'use strict';
