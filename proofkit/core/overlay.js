  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=758bb85cf1';
  import { pkConfirm, pkAlert } from './modal.js?v=758bb85cf1';
  import { injectCss } from './inject-css.js?v=758bb85cf1';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=758bb85cf1'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=758bb85cf1';
  import pkComponentsCss from './design/components.css.js?v=758bb85cf1';
  (() => {
    'use strict';
