  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=cb655fa246';
  import { pkConfirm, pkAlert } from './modal.js?v=cb655fa246';
  import { injectCss, injectFont } from './inject-css.js?v=cb655fa246';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=cb655fa246'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=cb655fa246';
  import pkComponentsCss from './design/components.css.js?v=cb655fa246';
  (() => {
    'use strict';
