  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=0ecc9df86d';
  import { pkConfirm, pkAlert } from './modal.js?v=0ecc9df86d';
  import { injectCss, injectFont } from './inject-css.js?v=0ecc9df86d';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=0ecc9df86d'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=0ecc9df86d';
  import pkComponentsCss from './design/components.css.js?v=0ecc9df86d';
  (() => {
    'use strict';
    ...
    const mountOverlayCss = () => { injectFont(); return injectCss(css); };
