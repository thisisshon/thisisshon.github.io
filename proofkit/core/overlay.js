  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=38b8e8f22b';
  import { pkConfirm, pkAlert } from './modal.js?v=38b8e8f22b';
  import { injectCss, injectFont } from './inject-css.js?v=38b8e8f22b';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=38b8e8f22b'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=38b8e8f22b';
  import pkComponentsCss from './design/components.css.js?v=38b8e8f22b';
  (() => {
    'use strict';
