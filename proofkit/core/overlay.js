  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=98617b8fb8';
  import { pkConfirm, pkAlert } from './modal.js?v=98617b8fb8';
  import { injectCss } from './inject-css.js?v=98617b8fb8';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=98617b8fb8'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=98617b8fb8';
  import pkComponentsCss from './design/components.css.js?v=98617b8fb8';
  (() => {
    'use strict';
