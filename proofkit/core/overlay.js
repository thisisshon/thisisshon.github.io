  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=29fc6d752c';
  import { pkConfirm, pkAlert } from './modal.js?v=29fc6d752c';
  import { injectCss } from './inject-css.js?v=29fc6d752c';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=29fc6d752c'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=29fc6d752c';
  import pkComponentsCss from './design/components.css.js?v=29fc6d752c';
  (() => {
    'use strict';
