  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=a46a57944c';
  import { pkConfirm, pkAlert } from './modal.js?v=a46a57944c';
  import { injectCss } from './inject-css.js?v=a46a57944c';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=a46a57944c'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=a46a57944c';
  import pkComponentsCss from './design/components.css.js?v=a46a57944c';
  (() => {
    'use strict';
