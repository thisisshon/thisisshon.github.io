  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=c3a5d053e2';
  import { pkConfirm, pkAlert } from './modal.js?v=c3a5d053e2';
  import { injectCss } from './inject-css.js?v=c3a5d053e2';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=c3a5d053e2'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=c3a5d053e2';
  import pkComponentsCss from './design/components.css.js?v=c3a5d053e2';
  (() => {
    'use strict';
