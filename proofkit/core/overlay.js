  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=5397a430ab';
  import { pkConfirm, pkAlert } from './modal.js?v=5397a430ab';
  import { injectCss } from './inject-css.js?v=5397a430ab';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=5397a430ab'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=5397a430ab';
  import pkComponentsCss from './design/components.css.js?v=5397a430ab';
  (() => {
    'use strict';
