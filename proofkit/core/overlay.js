  import { TEAMS, TEAM_COLORS, WORKER_URL, HIDE_SELECTORS, PROOFKIT_ENABLED, ADMIN_TEAM, isTeamEnabled,
    ...
    getOverlayUi, syncOverlayUi, startOverlayUiStream } from './config.js?v=63432d416e';
  import { pkConfirm, pkAlert } from './modal.js?v=63432d416e';
  import { injectCss, injectFont } from './inject-css.js?v=63432d416e';
  import { mountHud, CANVAS_FRAME_NAME } from './overlay-hud.js?v=63432d416e'; // New HUD path (overlayUi === 'new')
  ...
  import pkTokensCss from './design/tokens.css.js?v=63432d416e';
  import pkComponentsCss from './design/components.css.js?v=63432d416e';
  (() => {
    'use strict';
