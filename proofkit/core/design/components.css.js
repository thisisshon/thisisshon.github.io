...
.pk-access{display:flex;align-items:center;justify-content:center;gap:var(--pk-space-3);width:100%;margin:var(--pk-space-3) 0 var(--pk-space-3)}
...
.pk-access-box{width:42px;height:var(--pk-control-h-xl);padding:0;text-align:center;
...
.pk-access-sep{flex:none;width:var(--pk-space-3h);height:var(--pk-border-hair);background:var(--pk-hair)}
