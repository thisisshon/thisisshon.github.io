...
.pk-set-row{display:flex;align-items:center;justify-content:space-between;gap:var(--pk-space-4);padding:var(--pk-space-3h) 0;border-bottom:1px solid var(--pk-hair)}
