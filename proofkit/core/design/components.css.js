...
.pk-access-login--inline .pk-access-box{width:32px;height:44px;font-size:24px;border-radius:8px}
.pk-access-login--inline .pk-access-sep{width:8px}
...
.pk-access-box{width:42px;height:58px;padding:0;text-align:center;
  ...
  font:600 34px/1 var(--pk-font);letter-spacing:0;caret-color:var(--pk-red);
...
@media (max-width:480px){
  ...
  .pk-access{gap:6px}
  .pk-access-box{width:34px;height:48px;font-size:28px}
