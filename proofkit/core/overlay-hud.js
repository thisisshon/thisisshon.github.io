...
import { pageName, getSession, ADMIN_TEAM, TEAM_COLORS, STATUS_COLORS, renderSummary, PROJECT_SHORT,
  ...
  getTheme, isThemeKey, toggleTheme } from './config.js?v=38b8e8f22b';
import { injectCss, injectFont } from './inject-css.js?v=38b8e8f22b';   // CSP-safe sheet mount (see mountHud)
