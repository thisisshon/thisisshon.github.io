...
import { pageName, getSession, ADMIN_TEAM, TEAM_COLORS, STATUS_COLORS, renderSummary, PROJECT_SHORT,
  ...
  getTheme, isThemeKey, toggleTheme } from './config.js?v=63432d416e';
import { injectCss, injectFont } from './inject-css.js?v=63432d416e';   // CSP-safe sheet mount (see mountHud)
