...
import { pageName, getSession, ADMIN_TEAM, TEAM_COLORS, STATUS_COLORS, renderSummary, PROJECT_SHORT,
  ...
  getTheme, isThemeKey, toggleTheme } from './config.js?v=43a0734204';
import { injectCss, injectFont } from './inject-css.js?v=43a0734204';   // CSP-safe sheet mount (see mountHud)
