  import { TEAMS, TEAM_COLORS, WORKER_URL, PROOFKIT_ENABLED, pageName, pageHref, pageUrlText, ADMIN_TEAM,
    ...
    COMMENT_TYPES, TYPE_FIELDS, REOPEN_REASONS, STATUS_COLORS, reopenReasonLabel, renderSummary, needsExpectedOutcome, PROJECT_SHORT } from './config.js?v=74611b3e1e';
  ...
  import { PK_VERSION } from './version.js?v=74611b3e1e';
  import { createCardRenderer } from './card.js?v=74611b3e1e';
  import { ICON } from './icons.js?v=74611b3e1e';
  import { pkConfirm, pkAlert, pkPrompt } from './modal.js?v=74611b3e1e';
  import { openReopenModal, openDisregardModal } from './action-modals.js?v=74611b3e1e';
  (() => {
