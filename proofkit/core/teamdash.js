  import { TEAMS, TEAM_COLORS, WORKER_URL, PROOFKIT_ENABLED, pageName, pageHref, pageUrlText, ADMIN_TEAM,
    ...
    COMMENT_TYPES, TYPE_FIELDS, REOPEN_REASONS, STATUS_COLORS, reopenReasonLabel, renderSummary, needsExpectedOutcome, PROJECT_SHORT } from './config.js?v=a90a72a1c8';
  ...
  import { PK_VERSION } from './version.js?v=a90a72a1c8';
  import { createCardRenderer } from './card.js?v=a90a72a1c8';
  import { ICON } from './icons.js?v=a90a72a1c8';
  import { pkConfirm, pkAlert, pkPrompt } from './modal.js?v=a90a72a1c8';
  import { openReopenModal, openDisregardModal } from './action-modals.js?v=a90a72a1c8';
  (() => {
