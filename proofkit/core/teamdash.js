  import { TEAMS, TEAM_COLORS, WORKER_URL, PROOFKIT_ENABLED, pageName, pageHref, pageUrlText, ADMIN_TEAM,
    ...
    COMMENT_TYPES, TYPE_FIELDS, REOPEN_REASONS, STATUS_COLORS, reopenReasonLabel, renderSummary, needsExpectedOutcome, PROJECT_SHORT } from './config.js?v=9d97d34b43';
  ...
  import { PK_VERSION } from './version.js?v=9d97d34b43';
  import { createCardRenderer } from './card.js?v=9d97d34b43';
  import { ICON } from './icons.js?v=9d97d34b43';
  import { pkConfirm, pkAlert, pkPrompt } from './modal.js?v=9d97d34b43';
  import { openReopenModal, openDisregardModal } from './action-modals.js?v=9d97d34b43';
  (() => {
